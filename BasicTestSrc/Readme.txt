Firmware that is displaying simple static image using DisplayLink.
Source image ("image1_map") is stored in Flash, its size is 320x240, 16 bit color.
...
See test_fill() function in di_link_additional.c file to see how drawing is called.
